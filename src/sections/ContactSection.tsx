          ...
          <Box>
            ...
            <ScrollReveal delay={0.3}>
              ...
              >
                ...
                >
                  I'm currently based in Lahore and open to both remote and
                  on-site roles across Pakistan and globally. The best way to
            ...
            >
              {submitted ? (
                <Box sx={{ textAlign: "center", py: "2rem" }}>
                  ...
                  <Typography
                    sx={{ fontWeight: 700, fontSize: "1.2rem", mb: "0.5rem" }}
                  >
                    Message sent! 🎉
                  </Typography>
                  <Typography
                    variant="body2"
                    sx={{ color: "text.secondary", mb: "1.5rem" }}
                  >
